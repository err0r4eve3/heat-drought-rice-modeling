...
STEP_ORDER = [
    ...
    "exposure-diagnosis",
    "annual-exposure",
    "province-daily-climate",
    "province-daily-chd",
    "manual-yield",
    "province-grain-backfill",
    "province-chd",
    "province-panel",
    "indices",
    "modeling",
...
def build_step_commands(config_path: str) -> dict[str, list[str]]:
    ...
    return {
        ...
        "province-daily-climate": [python, "scripts/20_import_province_daily_climate.py"],
        "province-daily-chd": [python, "scripts/21_build_province_chd_from_daily_climate.py"],
        "manual-yield": [python, "scripts/17_import_manual_yield_panel.py"],
        "province-grain-backfill": [python, "scripts/22_import_province_grain_backfill.py"],
